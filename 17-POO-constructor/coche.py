class Coche:
    ...
    # con "__" al principio se convierte en atributo privado
    ...
    def getPrivado(self):       # Getter para poder acceder al atributo privado
    ...
    def getInfo(self):          # Getter que muestra toda la info. del coche
