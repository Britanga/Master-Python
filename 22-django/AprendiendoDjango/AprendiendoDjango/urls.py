...
from django.conf import settings # Para acceder a configuración para cargar imagenes

# Importar app con mis vistas
from miapp import views
#import miapp.views # Otra manera ("views" cambia a "miapp.views" en las diferentes rutas)

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', views.index, name="index"),
    path('inicio/', views.index, name="inicio"),
    path('hola-mundo-django/', views.hola_mundo, name="hola_mundo"), # Ruta del proyecto
    path('pagina-pruebas/', views.pagina, name="pagina"),
    # Redireccionando
    path('pagina-pruebas/<int:redirigir>', views.pagina, name="pagina"),
    # Parámetros En Rutas y Parámetros Opcionales
...
# Configuración para cargar imagenes o ficheros
if settings.DEBUG:
    # Permite pasar URL a un fichero estatico
    from django.conf.urls.static import static
    # Añade nueva URL en urlpatterns
    # static(URL=CarpetaGuardaImagenes, ROOT=DirectorioCompletoDondeEstanImagenes)
